...
def f(event, context):
    bucket_name = "parcial-lambda1"  # Bucket específico para esta función
...
def process_data(event, context):
    bucket_name = "parcial-lambda1"  # Bucket donde están los datos RAW
    processed_bucket_name = "parcial-lambda2"  # Bucket destino para el CSV

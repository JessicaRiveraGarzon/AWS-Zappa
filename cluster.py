...
CLUSTER_ID = 'j-1D867DJXMWL00'  # ID del clúster
LOG_URI = 's3://aws-logs-876867998800-us-east-1/elasticmapreduce/'  # Ruta de logs de S3
SCRIPT_PATH = 's3://jupyter3/german_credit/e-39XGRE080XYHK5Y2LQML9XQFM/pysparkParcial.py'  # Ruta al script Python en S3
INSTANCE_TYPE = 'm5.xlarge'  # Tipo de instancia para master y slave
INSTANCE_COUNT = 3  # Número de instancias
SERVICE_ROLE = 'arn:aws:iam::876867998800:role/EMR_DefaultRole'  # Rol de servicio de EMR
...
BOOTSTRAP_SCRIPT_PATH = 's3://parcial-lambda3/headlines/bootstrap.sh'
...
def create_cluster():
    ...
    response = emr_client.run_job_flow(
        ...
        Instances={
            ...
            'Ec2SubnetId': 'subnet-01af68f08f9341d70',  # Subnet ID
            'EmrManagedMasterSecurityGroup': 'sg-0ac24b243b6de12bb',
            'EmrManagedSlaveSecurityGroup': 'sg-057fdadf9fee430d5',
        },
        BootstrapActions=[
            {
